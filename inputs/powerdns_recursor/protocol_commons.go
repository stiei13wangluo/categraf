...
func writeNativeUIntToConn(conn net.Conn, value uint) error {
	...
	case 4:
		binary.LittleEndian.PutUint32(intData, uint32(value))
	case 8:
		binary.LittleEndian.PutUint64(intData, uint64(value))
	default:
...
func readNativeUIntFromConn(conn net.Conn) (uint, error) {
	...
	switch uintSizeInBytes {
	case 4:
		return uint(binary.LittleEndian.Uint32(intData)), nil
	case 8:
		return uint(binary.LittleEndian.Uint64(intData)), nil
	default:
